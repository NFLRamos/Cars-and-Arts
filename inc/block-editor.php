...
add_action( 'after_setup_theme', 'carsandarts_block_editor_setup' );

if ( ! function_exists( 'carsandarts_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function carsandarts_block_editor_setup() {
		...
		$color_palette = carsandarts_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'carsandarts_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function carsandarts_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'carsandarts_theme_editor_color_palette', $color_palette );
	}
}
