...
if ( ! function_exists( 'carsandarts_adjust_body_class' ) ) {
	 ...
	 */
	function carsandarts_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'carsandarts_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function carsandarts_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'carsandarts' ),
		__( 'Previous', 'carsandarts' ),
		__( 'Next', 'carsandarts' ),
		__( 'About:', 'carsandarts' ),
		__( 'Profile', 'carsandarts' ),
		__( 'Posts by', 'carsandarts' ),
		__( 'Permanent Link:', 'carsandarts' ),
		__( 'in', 'carsandarts' ),
		__( 'Edit', 'carsandarts' ),
	);
}
